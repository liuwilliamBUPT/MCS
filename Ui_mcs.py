...
class Ui_MCS(object):
    def setupUi(self, MCS):
        ...
        self.horizontalScrollBar.setMaximum(4000)
        ...
        self.actionAxes_Color = QtWidgets.QAction(MCS)
        self.actionAxes_Color.setObjectName("actionAxes_Color")
        ...
        self.actionFigure_Color = QtWidgets.QAction(MCS)
        self.actionFigure_Color.setObjectName("actionFigure_Color")
        ...
        self.menuColor_Setting.addAction(self.actionAxes_Color)
        self.menuColor_Setting.addAction(self.actionFigure_Color)
    ...
    def retranslateUi(self, MCS):
        ...
        self.label_3.setText(_translate("MCS", "周期 (s)"))
        self.label_2.setText(_translate("MCS", "频率 (Hz)"))
        ...
        self.actionAxes_Color.setText(_translate("MCS", "Axes Color"))
        ...
        self.actionExport_Data.setShortcut(_translate("MCS", "Ctrl+E"))
        ...
        self.actionFigure_Color.setText(_translate("MCS", "Figure Color"))
